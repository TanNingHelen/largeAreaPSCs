    ...
    def _generate_line_chart(self, results_df):
        ...
        try:
            ...
            if len(high_pce_data) > 0:
                ...
                # 修改：去掉推荐区间的边框
                # 删除了以下两行代码：
                # plt.axvline(x=high_recommended_width_min, color='black', linestyle='--', linewidth=1.5, alpha=0.8)
                # plt.axvline(x=high_recommended_width_max, color='black', linestyle='--', linewidth=1.5, alpha=0.8)
